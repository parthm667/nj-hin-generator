...
Possible injury (KABCO C) is a separate recorded category, not a confirmed minor
or serious injury and not property damage. It has a default descriptive weight
of 3, the same as minor injury; this choice does not alter count-based significance
or estimate the number of injured people.
...
Dashboard severity ratings and casualty evidence can disagree. Such records retain
their source details; an ambiguous injury rating remains unknown, while explicit
fatal-crash evidence can support a fatal classification. Review these conflicts
before interpreting recorded severity as a complete injury breakdown.
\newpage
